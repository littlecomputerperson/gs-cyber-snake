#!/bin/bash
# filepath: /mnt/HD/Projects/GameSystem/SDL2/CyberSnake/build_macos.sh
# macOS build script for Cyber Snake

set -e  # Exit on error

echo "========================================"
echo " CyberSnake - macOS Build Script"
echo "========================================"
echo ""
...
echo "========================================"
echo ""
echo "Application bundle: build/CyberSnake.app"
echo ""
echo "Verifying bundle contents..."
if [ -d "build/CyberSnake.app/Contents/Resources/data" ]; then
    echo "✓ Data folder copied to bundle"
else
    echo "✗ Data folder NOT found in bundle"
fi

if [ "$(ls -A build/CyberSnake.app/Contents/Resources/*.ini 2>/dev/null)" ]; then
...
echo "  open build/CyberSnake.app"
echo "  or double-click CyberSnake.app in Finder"
echo ""
