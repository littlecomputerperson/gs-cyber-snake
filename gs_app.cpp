...
// time on the next call. GS_Snake::GetActionInterval() scales unclamped frame time directly into
// simulation ticks, so that single frame can replay dozens of movement ticks synchronously --
// long enough to wrap the snake into itself and to make the call itself take visibly long.
// ---------------------------------------------------------------------------------------------
